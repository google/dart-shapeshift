...
class _UIManager {
  ...
  Future _writeContent(String library) async {
    ...
    try {
      ...
      _content.children.add(_progressNotification('Loading $library ...'));
      ...
      if (_content.children.isEmpty) {
        _content.children.add(_progressNotification('No changes.'));
      }
...
DivElement _progressNotification(String things) =>new DivElement()
